...
const Hero = () => {
  const TEXTS=['Acupuncture','Massage','Chiropractor','Dental','Cosmetic','Dietitian',"Speech Therapist","Speech Therapist","Occupational Therapist","Acupuncturist"];
  return (
    <>
            ...
            <div className="w-full px-4 lg:w-6/12">
              <div className="hero-content">
                ...
                <p className="mb-8 max-w-[480px] text-base text-gray-100 dark:text-gray-50-6">
                  Health shouldn't be a puzzle, we are cutting through the B.S to bring 
                  you simple, affordable, and transparent healthcare.
                </p>
                {/* Search */}
                <SearchBar/>
                <ul className="flex flex-wrap items-center mt-6">
                  ...
                  <li>
                    ...
                    >
                      <span className="mr-2">
                        <Pill className="flex-shrink-0 h5 w-5 text-blue-600"/>
                      </span>
                     Need a Refill
                    </a>
                  </li>
